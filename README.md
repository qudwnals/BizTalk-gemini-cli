...
`index.html` 파일을 웹 브라우저에서 엽니다. (예: `file:///path/to/your/project/frontend/index.html`)
...
이 프로젝트는 현재 `qudwnals`에 의해 관리되고 있습니다. 기여에 대한 문의는 프로젝트 소유자에게 직접 연락 바랍니다.

## 라이선스

이 프로젝트는 별도의 라이선스 명시가 없는 한 모든 권리는 `qudwnals`에게 있습니다.